...
def create_room_background(room_name):
    ...
    if room_name == "School Hall":
        ...
        for i in range(3):
            x = 100 + i * 200
            pygame.draw.rect(surf, (150, 200, 240), (x, 60, 80, 100))
            pygame.draw.rect(surf, (100, 80, 70), (x, 60, 80, 100), 4)
            pygame.draw.line(surf, (100, 80, 70), (x+40, 60), (x+40, 160), 4)
        
        # Door frames
        for door_x in [20, SCREEN_WIDTH-100]:
            pygame.draw.rect(surf, (100, 80, 60), (door_x, SCREEN_HEIGHT-150, 80, 120))
            pygame.draw.rect(surf, (80, 60, 40), (door_x+10, SCREEN_HEIGHT-140, 60, 100))
...
ROOMS = {
    'hall': {
        ...
        'spawn': (320, 350),
        'collision_rects': [
            pygame.Rect(0, 0, SCREEN_WIDTH, 180),  # Top wall
            pygame.Rect(0, 0, 40, SCREEN_HEIGHT),  # Left wall
            pygame.Rect(SCREEN_WIDTH-40, 0, 40, SCREEN_HEIGHT),  # Right wall
            pygame.Rect(0, SCREEN_HEIGHT-40, SCREEN_WIDTH, 40),  # Bottom wall
        ],
        'doors': {
            'buffet': {'rect': pygame.Rect(10, 200, 40, 80), 'target': 'buffet', 'spawn': (560, 240)},
            'locker': {'rect': pygame.Rect(SCREEN_WIDTH-50, 200, 40, 80), 'target': 'locker', 'spawn': (80, 240)},
            'bathroom': {'rect': pygame.Rect(200, SCREEN_HEIGHT-50, 80, 40), 'target': 'bathroom', 'spawn': (240, 80)},
            'classroom': {'rect': pygame.Rect(360, SCREEN_HEIGHT-50, 80, 40), 'target': 'classroom', 'spawn': (320, 80)}
        },
        'npcs': [
            {'id': 'principal', 'x': 320, 'y': 240, 'name': 'Principal Smith', 'color': (200, 100, 100), 'personality': 'serious'}
        ]
    },
    'classroom': {
        'name': "Classroom",
        'spawn': (320, 400),
        'collision_rects': [
            pygame.Rect(0, 0, SCREEN_WIDTH, 180),
        ...
        'doors': {
            'hall': {'rect': pygame.Rect(SCREEN_WIDTH//2-40, 30, 80, 40), 'target': 'hall', 'spawn': (360, 400)}
        },
        'npcs': [
            {'id': 'teacher', 'x': 320, 'y': 200, 'name': 'Ms. Johnson', 'color': (128, 0, 128), 'personality': 'teacher'},
            {'id': 'student1', 'x': 180, 'y': 320, 'name': 'Alex', 'color': (100, 180, 100), 'personality': 'friendly'}
        ]
    },
    'locker': {
        'name': "Locker Room",
        ...
        'doors': {
            'hall': {'rect': pygame.Rect(10, 200, 40, 80), 'target': 'hall', 'spawn': (560, 240)},
            'outside': {'rect': pygame.Rect(SCREEN_WIDTH-50, 350, 40, 80), 'target': 'outside', 'spawn': (80, 240)}
        },
        'npcs': [
            {'id': 'janitor', 'x': 320, 'y': 260, 'name': 'Mr. Rodriguez', 'color': (139, 115, 85), 'personality': 'janitor'}
        ]
    },
    'bathroom': {
        'name': "Boys Bathroom",
        ...
        'doors': {
            'hall': {'rect': pygame.Rect(SCREEN_WIDTH//2-40, 30, 80, 40), 'target': 'hall', 'spawn': (240, 400)}
        },
        'npcs': [
            {'id': 'student2', 'x': 200, 'y': 300, 'name': 'Jamie', 'color': (240, 220, 100), 'personality': 'normal'}
        ]
    },
    'buffet': {
        'name': "School Buffet",
        ...
        'collision_rects': [
            ...
            pygame.Rect(SCREEN_WIDTH-40, 0, 40, SCREEN_HEIGHT),
            pygame.Rect(0, SCREEN_HEIGHT-40, SCREEN_WIDTH, 40),
            pygame.Rect(150, 200, 340, 60),  # Counter
        ],
        'doors': {
            'hall': {'rect': pygame.Rect(SCREEN_WIDTH-50, 200, 40, 80), 'target': 'hall', 'spawn': (80, 240)}
        },
        'npcs': [
            {'id': 'shopkeeper', 'x': 320, 'y': 220, 'name': 'Mrs. Baker', 'color': (255, 180, 200), 'personality': 'friendly'}
        ]
    },
    'outside': {
        'name': "School Yard",
        ...
        'doors': {
            'locker': {'rect': pygame.Rect(10, 200, 40, 80), 'target': 'locker', 'spawn': (560, 350)}
        },
        'npcs': [
            {'id': 'student3', 'x': 400, 'y': 280, 'name': 'Chris', 'color': (100, 160, 220), 'personality': 'friendly'}
        ]
    }
}
...
class Game:
    ...
    def draw_player(self):
        ...
        player_sprite = create_player_sprite(self.animation_frame if self.is_moving else 0)
